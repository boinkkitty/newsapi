...
import (
	...
	store "github.com/boinkkitty/newsapi/internal/store"
...
func (mr *MockNewsStorerMockRecorder) UpdateByID(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateByID", reflect.TypeOf((*MockNewsStorer)(nil).UpdateByID), body)
}
